...
{
    Task<IntegrationSettingEntity?> GetByProviderAsync(string provider, CancellationToken cancellationToken = default);
    Task<List<IntegrationSettingEntity>> GetAllActiveAsync(CancellationToken cancellationToken = default);
    Task<IntegrationSettingEntity> SaveAsync(IntegrationSettingEntity setting, CancellationToken cancellationToken = default);
    Task<bool> DeleteAsync(string provider, CancellationToken cancellationToken = default);
}
...
public class IntegrationSettingRepository : IIntegrationSettingRepository
{
    ...
    public async Task<IntegrationSettingEntity?> GetByProviderAsync(string provider, CancellationToken cancellationToken = default)
    {
        return await _context.IntegrationSettings
            .FirstOrDefaultAsync(s => s.Provider == provider && s.IsActive, cancellationToken);
    }

    public async Task<List<IntegrationSettingEntity>> GetAllActiveAsync(CancellationToken cancellationToken = default)
    {
        return await _context.IntegrationSettings
            .Where(s => s.IsActive)
    ...
    public async Task<IntegrationSettingEntity> SaveAsync(IntegrationSettingEntity setting, CancellationToken cancellationToken = default)
    {
        var existing = await _context.IntegrationSettings
            .FirstOrDefaultAsync(s => s.Provider == setting.Provider, cancellationToken);
    ...
    public async Task<bool> DeleteAsync(string provider, CancellationToken cancellationToken = default)
    {
